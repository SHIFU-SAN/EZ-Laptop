...
const CommentsNotificationServices = require("../services/CommentsNotificationServices");
...
class CommentsNotificationController {
    static async addNotification(req, res) {
        try {
            const NewNotification = await CommentsNotificationServices.createNotification(req.body);
    ...
    static async getNotifications(req, res) {
        try {
            const NotificationsList = await CommentsNotificationServices.readNotifications();
    ...
    static async getNotificationByID(req, res) {
        try {
            const NotificationTarget = await CommentsNotificationServices.readNotificationByID(req.params.id);
    ...
    static async setNotification(req, res) {
        try {
            const NotificationTarget = await CommentsNotificationServices.updateNotification(req.params.id, req.body);
            return res.status(200).json(NotificationTarget);
        } catch (err) {
            res.status(400);
    ...
    static async addProduct(req, res) {
        try {
            const NewProduct = await CommentsNotificationServices.createProduct(req.params.id, req.body);
    ...
    static async addMoreProducts(req, res) {
        try {
            ...
            const NewProducts = req.body.map(async product => await CommentsNotificationServices.createProduct(NotificationID, product));
    ...
    static async removeProduct(req, res) {
        try {
            const ProductRemoved = await CommentsNotificationServices.deleteProduct(req.params.id, req.params.product_id);
    ...
    static async removeProducts(req, res) {
        try {
            const ProductsRemoved = await CommentsNotificationServices.deleteProducts(req.params.id);
    ...
    static async removeNotification(req, res) {
        try {
            const NotificationRemoved = await CommentsNotificationServices.deleteNotification(req.params.id);
