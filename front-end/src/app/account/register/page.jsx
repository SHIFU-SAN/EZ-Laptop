...
function RegisterPage() {
    ...
    return <div className="h-screen px-2 bg-[#80CBC4] flex flex-col items-center">
        ...
        <div className="w-full md:w-2/3 lg:w-1/3 px-2 md:px-4 pt-4 lg:pt-8 pb-8 bg-[#FBF8EF] rounded-lg flex flex-col items-center gap-4">
            <form action={handleRegister}
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-1">
                    <label htmlFor='ConfirmPassword' className='min-w-[160px]'>Nhập lại mật khẩu<span
                        className='text-red-500'>*</span>:</label>
            ...
            <p className="font-light italic">Đã có tài khoản? <Link href="./login"
